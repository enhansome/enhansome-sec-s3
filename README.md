...
| [bucket-stream](https://github.com/eth0izzle/bucket-stream) ⭐ 1,814 \| 🐛 9 \| 🌐 Python \| 📅 2025-02-28                     | Find S3 Buckets by watching certificate transparency logs                   |
...
| [s3m](https://github.com/s3m/s3m) ⭐ 56 \| 🐛 0 \| 🌐 Rust \| 📅 2026-09-19                                     | CLI for streams of data in S3 buckets                              |
...
* [List of AWS S3 Leaks](https://github.com/nagwww/s3-leaks) ⭐ 458 | 🐛 0 | 🌐 Python | 📅 2026-08-20 - Comprehensive list of documented S3 data exposures
